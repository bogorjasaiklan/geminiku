...
export async function parseArguments() {
    const yargsInstance = yargs(hideBin(process.argv))
        ...
        type: 'boolean',
        description: 'If true, when refreshing memory, GEMINI.md files should be loaded from all directories that are added. If false, GEMINI.md files should only be loaded from the primary working directory.',
        default: false,
    })
        .check((argv) => {
...
export async function loadCliConfig(settings, extensions, sessionId, argv) {
    ...
    return new Config({
        ...
        includeDirectories,
        loadMemoryFromIncludeDirectories: argv.loadMemoryFromIncludeDirectories ||
