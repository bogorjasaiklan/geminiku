...
describe('ClearcutLogger', () => {
    ...
    const getMaxEvents = (l) => l['max_events'];
    const getMaxRetryEvents = (l) => l['max_retry_events'];
    ...
    describe('enqueueLogEvent', () => {
        ...
        it('should evict the oldest event when the queue is full', () => {
            ...
            const lastEvent = JSON.parse(getEvents(logger)[maxEvents - 1][0].source_extension_json);
    ...
    describe('flushToClearcut', () => {
        ...
        beforeEach(() => {
            ...
            mockHttps.request.mockImplementation((_options, ...args) => {
        ...
        it('should clear events on successful flush', async () => {
            ...
            expect(response.nextRequestWaitMs).toBe(mockResponseBody.nextRequestWaitMs);
        });
