...
export class MemoryTool extends BaseTool {
    ...
    constructor() {
        super(MemoryTool.Name, 'Save Memory', memoryToolDescription, Icon.LightBulb, memoryToolSchemaData.parameters);
    }
    ...
    getModifyContext(_abortSignal) {
        return {
            ...
            getCurrentContent: async (_params) => this.readMemoryFileContent(),
